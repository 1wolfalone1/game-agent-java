...
public class RegistrationFilter implements Filter {
    ...
    private void doAfterProcessing(ServletRequest request, ServletResponse response)
        ...
        String meg = (String) req.getAttribute("megg");
        if (meg != null && meg.equals("successful")) {
            try {
                AccountDTO account = (new AccountDAO()).getAccountByLogin(req.getParameter("accName"),
                        req.getParameter("password"));
                UserDTO user = (new UserDAO()).getUserByCmnd(req.getParameter("ID"));
                ...
                res.sendRedirect(EnumActionMap.LOGIN_HTML.getKey());
            }
